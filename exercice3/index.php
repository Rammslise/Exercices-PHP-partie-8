...
if (isset($_POST['login']) && isset($_POST['password'])) {
    setcookie('cookieLogin', $_POST['login'], time() + 3600, '/', 'phpPartie8');
    setcookie('cookiePassword', $_POST['password'], time() + 3600, '/', 'phpPartie8');
    //var_dump($_COOKIE);
}
?>
<!DOCTYPE html>
            ...
            <div class="tab-pane fade show active" id="data">                                            
                <div class="row justify-content-center">
                    <div class="card border-info mb-3 text-center ">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Créer votre espace</h5>
