...
<html lang="fr" dir="ltr">
    <head>
        ...
        <title>Variables superglobales, sessions et cookies, exercice 1</title>
    </head>
            ...
            <div class="tab-pane fade show active" id="data">                                            
                <div class="row justify-content-center">
                    <div class="card border-info mb-3 text-center ">
                        <h3 class="card-header">Infos pratiques</h3>
                        <div class="card-body">
                            <h5 class="card-title">Vous concernant </h5>
                            <h6 class="card-subtitle text-muted">Merci de bien vérifier vos informations</h6>
                        </div>
                        <div class="card-body text-center">                      
                            <form method="post" action="index.php">
                                <div class="form-row">
                                    <div class="card-body text-center">
                                        <!-- on demande de récupérer et afficher le user agent, l'adresse ip et le nom du serveur -->
                                        <?php
                                        ...
                                        echo 'User Agent : ' . $_SERVER['HTTP_USER_AGENT'] . '.<br/> Adresse IP : ' . $_SERVER['SERVER_ADDR'] . '.<br/> Nom du serveur : ' . $_SERVER['SERVER_NAME'] . '.';
                                        ?>
                                    </div> 
                                </div>
                                <!-- Footer du form -->
