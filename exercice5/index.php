<?php
//pour simplifier, le changement de value n'est pas obligatoire, il suffit de changer le label for='' de l'id et du mdp.
if (isset($_POST['newLogin']) && isset($_POST['newPassword'])) {
    setcookie('cookieLogin', $_POST['newLogin'], time() + 3600, '/', 'phpPartie8');
    setcookie('cookiePassword', $_POST['newPassword'], time() + 3600, '/', 'phpPartie8');
}
?>
<!DOCTYPE html>
<html lang="fr" dir="ltr">
    <head>
        ...
        <title>Variables superglobales, sessions et cookies, exercice 3</title>
    </head>
            ...
            <div class="tab-pane fade show active" id="data">                                            
                <div class="row justify-content-center">
                    <div class="card border-info mb-3 text-center ">
                        <h3 class="card-header">Formulaire de modifications</h3>
                        <div class="card-body">
                            <h5 class="card-title">Modifier vos informations</h5>
                            <h6 class="card-subtitle text-muted">Merci de remplir les champs</h6>
                        </div>
                                ...
                                <div class="form-row">
                                    <div class="card-body text-center">
                                        <div class="card-body text-center">                                   
                                            ...
                                            <input type="text" class="form-control" name="newLogin" id="newLogin" placeholder="Identifiant" required>                                 
                                        </div>
                                        <div class="card-body text-center form-group">
                                            <label for="newPassword">Nouveau mot de passe :</label>
                                            <input type="password" class="form-control" name="newPassword" id="newPassword" placeholder="Mot de passe" required>
                                        </div>   
                                        <input name="modify" type="submit" value="Modifier" />
                                    </div>
                                </div>                                                      
                            </form> 
                            <a href="http://phppartie8/exercice4/index.php" class="btn btn-info">Afficher les cookies</a>          
                        </div>
                    </div>
                </div>
            </div>
